...
{
    // Xử lý thanh toán QR Pay thành công
    ...
    session()->forget(['cart', 'order_id', 'order_number', 'order_status']);
    
    request()->session()->flash('success', 'Thanh toán thành công! Cảm ơn bạn đã mua hàng.');
    return redirect()->route('home');
}
