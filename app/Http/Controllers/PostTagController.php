...
class PostTagController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($status) {
            request()->session()->flash('success', 'Post Tag added successfully');
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($status) {
            request()->session()->flash('success', 'Post Tag updated successfully');
        } else {
            request()->session()->flash('error', 'Please try again!!');
        }
    ...
    public function destroy($id)
    {
        ...
        if ($status) {
            request()->session()->flash('success', 'Post Tag deleted successfully');
        } else {
